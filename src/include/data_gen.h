...
#define MACROS_GET_ARRAY_CELL(vector_of_points, number_of_cells) \
    double array_of_cell[number_of_cells][NUMBER_OF_POINTS_PER_CELL][NUMBER_OF_COORDINATES_AT_POINT]; \
...
double *get_collocation_points(double *array_of_points, int number_of_cells);
