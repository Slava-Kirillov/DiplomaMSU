...
void write_all_result_in_files(float *collocation_points,
                               float *cell_area,
...
int main(int argc, char **argv) {
    ...
    float *collocation_points = get_collocation_points(struct_of_points->array, struct_of_points->number_of_cell);

    // получить массив площадей ячеек разбиения
    float *cell_area = get_array_of_cell_area(struct_of_points->array, struct_of_points->number_of_cell);
